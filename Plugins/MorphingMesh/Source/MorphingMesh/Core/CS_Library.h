...
public:
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		SHADER_PARAMETER_TEXTURE(Texture3D, BoneIndicesTexture)
		SHADER_PARAMETER_SAMPLER(SamplerState, BoneIndicesSampler)
		SHADER_PARAMETER_RDG_BUFFER_UAV(RWStructuredBuffer<float4>, BoneIndicesBuffer)
		SHADER_PARAMETER_TEXTURE(Texture3D, BoneWeightsTexture)
		SHADER_PARAMETER_SAMPLER(SamplerState, BoneWeightsSampler)
		SHADER_PARAMETER_RDG_BUFFER_UAV(RWStructuredBuffer<float4>, BoneWeightsBuffer)
	END_SHADER_PARAMETER_STRUCT()
};
...
public:
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, BoneIndicesBuffer)
		SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, BoneWeightsBuffer)
