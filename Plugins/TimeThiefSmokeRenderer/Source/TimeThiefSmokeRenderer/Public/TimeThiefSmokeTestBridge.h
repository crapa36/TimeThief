...
struct TIMETHIEFSMOKERENDERER_API FTimeThiefSmokeTestGpuPassResult
{
	...
	uint32 BoundaryNoiseOctaveCount = 0;
	uint32 DensityNoiseOctaveCount = 0;
	uint32 FilamentNoiseOctaveCount = 0;
	uint32 ShadowNoiseOctaveCount = 0;
	uint32 CombinedShadowStepSampleCount = 0;
	uint32 CombinedShadowMediumSampleCount = 0;
	uint32 BoundaryEvaluationCount = 0;
	uint32 BoundaryCoarseNoiseEvaluationCount = 0;
	uint32 BoundaryFineNoiseEvaluationCount = 0;
	uint32 BoundaryInteriorSkipCount = 0;
	uint32 BoundaryExteriorRejectCount = 0;
	uint32 ShadowIntervalSkipCount = 0;
	uint32 ShadowOpticalDepthEarlyOutCount = 0;
	uint32 ShadowAdaptiveDoubleStepCount = 0;
	uint32 ShadowEllipsoidRejectCount = 0;
