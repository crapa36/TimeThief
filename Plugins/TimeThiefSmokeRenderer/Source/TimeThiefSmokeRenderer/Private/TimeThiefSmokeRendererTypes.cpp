...
FTimeThiefSmokeRendererSettings::FTimeThiefSmokeRendererSettings()
	...
	, SelfShadowLightDirection(TimeThiefSmokeParameterDefaults::GetSelfShadowLightDirection())
	, SelfShadowStrength(TimeThiefSmokeParameterDefaults::SelfShadowStrength)
	, SelfShadowExtinction(TimeThiefSmokeParameterDefaults::SelfShadowExtinction)
	, SelfShadowStepCount(TimeThiefSmokeParameterDefaults::SelfShadowStepCount)
	, SelfShadowStepLength(TimeThiefSmokeParameterDefaults::SelfShadowStepLength)
