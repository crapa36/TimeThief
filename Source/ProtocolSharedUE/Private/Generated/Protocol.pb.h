...
struct PROTOCOLSHAREDUE_API TableStruct_Protocol_2eproto {
  static const uint32_t offsets[];
};
PROTOCOLSHAREDUE_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Protocol_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace se {
namespace protocol {
