...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_game_2fgame_5fenums_2eproto PROTOCOLSHAREDUE_API
...
struct PROTOCOLSHAREDUE_API TableStruct_game_2fgame_5fenums_2eproto {
  static const uint32_t offsets[];
};
PROTOCOLSHAREDUE_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_game_2fgame_5fenums_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace se {
namespace game {
...
PROTOCOLSHAREDUE_API bool WeaponStatType_IsValid(int value);
...
PROTOCOLSHAREDUE_API const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* WeaponStatType_descriptor();
template<typename T>
