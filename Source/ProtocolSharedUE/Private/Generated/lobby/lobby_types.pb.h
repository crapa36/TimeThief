...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_lobby_2flobby_5ftypes_2eproto PROTOCOLSHAREDUE_API
...
struct PROTOCOLSHAREDUE_API TableStruct_lobby_2flobby_5ftypes_2eproto {
  static const uint32_t offsets[];
};
PROTOCOLSHAREDUE_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_lobby_2flobby_5ftypes_2eproto;
namespace se {
namespace lobby {
class PlayerProfile;
struct PlayerProfileDefaultTypeInternal;
PROTOCOLSHAREDUE_API extern PlayerProfileDefaultTypeInternal _PlayerProfile_default_instance_;
}  // namespace lobby
}  // namespace se
PROTOBUF_NAMESPACE_OPEN
template<> PROTOCOLSHAREDUE_API ::se::lobby::PlayerProfile* Arena::CreateMaybeMessage<::se::lobby::PlayerProfile>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace se {
namespace lobby {
...
class PROTOCOLSHAREDUE_API PlayerProfile final :
